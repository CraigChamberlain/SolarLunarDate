...
namespace SolarLunarName.Standard.Tests
{
    ...
    {   
        ...
        public void GetSolarLunarMonthDetailedShould_InputIs1700_ReturnCorrectMonthData()
        {
            ...
            var phasesLiteral = new List <Models.MoonPhaseEntity>{
                new Models.MoonPhaseEntity(DateTime.Parse("1700-01-01T00:00:00"), DateTime.Parse("1700-01-01T00:00:00"), DateTime.Parse("1700-01-04T00:00:00"), Models.Moon.MoonPhase.Partial, 4),
                new Models.MoonPhaseEntity(DateTime.Parse("1700-01-05T10:30:00"), DateTime.Parse("1700-01-05T00:00:00"), DateTime.Parse("1700-01-11T00:00:00"), Models.Moon.MoonPhase.FullMoon, 7),
            };
            
            var monthLiteral = new Models.LunarSolarCalendarMonthDetailed(19, 0, DateTime.Parse("1700-01-01T00:00:00"), phasesLiteral);
